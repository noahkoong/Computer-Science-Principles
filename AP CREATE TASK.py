...
if winner:
    ...
    print('{} is the winner! The correct phrase was {}'.format(winner.name, phrase))
    print('{} , you won ${}'.format(winner.name, winner.prizeMoney))
    if len(winner.prizes) > 0:
        print('{} you also won:'.format(winner.name))
